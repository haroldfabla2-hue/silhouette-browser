...
class Optimization-Team:
    def __init__(self):
        self.team_name = "optimization-team"
        self.port = 8033
        self.apis_config = {
  ...
  "SERPER_API_KEY": "d74e67409311b703a73b1d30e457a2232194b154c296ee3c2ba16fb44d942"
    ...
    async def process_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "optimization-team" == "audiovisual-team":
            return await self.handle_audiovisual_task(task_data)
        elif "optimization-team" == "marketing_team":
            return await self.handle_marketing_task(task_data)
        elif "optimization-team" == "business_development_team":
