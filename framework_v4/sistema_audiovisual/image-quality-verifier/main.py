...
class Image-Quality-Verifier:
    def __init__(self):
        self.team_name = "image-quality-verifier"
        self.port = 8069
        self.apis_config = {
  ...
  "SERPER_API_KEY": "d74e67409311b703a73b1d30e457a2232194b154c296ee3c2ba16fb44d942"
    ...
    async def process_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "image-quality-verifier" == "audiovisual-team":
            return await self.handle_audiovisual_task(task_data)
        elif "image-quality-verifier" == "marketing_team":
            return await self.handle_marketing_task(task_data)
        elif "image-quality-verifier" == "business_development_team":
