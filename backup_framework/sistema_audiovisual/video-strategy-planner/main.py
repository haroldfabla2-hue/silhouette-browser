...
class Video-Strategy-Planner:
    def __init__(self):
        self.team_name = "video-strategy-planner"
        self.port = 8074
        self.apis_config = {
  ...
  "SERPER_API_KEY": "d74e67409311b703a73b1d30e457a2232194b154c296ee3c2ba16fb44d942"
    ...
    async def process_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "video-strategy-planner" == "audiovisual-team":
            return await self.handle_audiovisual_task(task_data)
        elif "video-strategy-planner" == "marketing_team":
            return await self.handle_marketing_task(task_data)
        elif "video-strategy-planner" == "business_development_team":
