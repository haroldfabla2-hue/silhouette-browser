...
class NotificationsCommunicationTeam:
    def __init__(self):
        self.team_name = "notifications_communication_team"
        self.port = 8014
        self.apis_config = {
  ...
  "SERPER_API_KEY": "d74e67409311b703a73b1d30e457a2232194b154c296ee3c2ba16fb44d942"
    ...
    async def process_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "notifications_communication_team" == "audiovisual-team":
            return await self.handle_audiovisual_task(task_data)
        elif "notifications_communication_team" == "marketing_team":
            return await self.handle_marketing_task(task_data)
        elif "notifications_communication_team" == "business_development_team":
    ...
    async def handle_audiovisual_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "status": "success",
            "team": "notifications_communication_team",
...
async def main():
    ...
    team = NotificationsCommunicationTeam()
